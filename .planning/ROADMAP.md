...
- [x] **Phase 68: Game Updates** - Migrate all games to player.color (complete 2026-01-25)
...
Plans:
- [x] 68-01-PLAN.md — Migrate Hex and Checkers to player.color API, remove deprecated imports and fallbacks
...
| 68. Game Updates | 1/1 | Complete | 2026-01-25 |
