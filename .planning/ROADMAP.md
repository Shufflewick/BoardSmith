...
- [x] 167-01-PLAN.md — SKILLAUTO-01: milestone playtest gates (SKETCH milestone flag + milestone/UI-gated human stop) [wave 1]
...
- [ ] 169-05-PLAN.md — doom-machine sweep (DEFER D9 rewrite, gate D12/D23) + BS-10 reclassify + D32 no-op + green suite + ledger [SWEEP-01, PROC-01] (wave 5)
...
| 169. Post-Fix Game De-Workaround Sweep | 2/6 | In Progress|  |
