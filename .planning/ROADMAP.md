...
- [x] 148-03-PLAN.md — Real install-to-temp-dir test (layout + references-resolve + no-residual + rename) + full-suite-green + zero-dep gate
...
- [x] 149-02-PLAN.md — Chunk-1 build leg: follow bs/build-chunk.md steps (investigate→redteam→build→test, audit→repair) → generated chunk-1 code + REAL automated checks + hidden-hand leak check; ask/playtest gates captured
- [x] 149-03-PLAN.md — Compare vs hand-built go-fish, fix pipeline defects at source (bs/ drift suites green), write 149-DRYRUN-REPORT.md + create HUMAN-UAT playtest item
