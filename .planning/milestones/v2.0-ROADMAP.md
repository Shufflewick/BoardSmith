# Roadmap Archive: BoardSmith v2.0 Collapse the Monorepo
...
- Source-based exports (TypeScript files, bundler consumers compile)
- Relative imports with .js extension for ESM compliance
- Games extracted to ~/BoardSmithGames/ as separate git repos
- CLI context detection via src/engine/ directory presence

**Issues Resolved:**

- Workspace protocol dependencies eliminated
- Cross-package import complexity eliminated
- Game/library coupling eliminated
