...
Visual (p.1): The Distribution of Cards diagram shows four rows of cards numbered 1 through 7, one row per color — red, green, blue, and purple — each row annotated "x 4". Below them is a single black card showing "+1" annotated "x 7".
...
Visual (p.1): Card art is minimal and bold: rounded-corner rectangles in flat saturated color (red, green, blue, purple) with a large white number centered, plus small white pip dots in the corners. Bonus cards are black with a white "+1". Aspect ratio of the depicted cards is roughly portrait, approximately 2:3.
