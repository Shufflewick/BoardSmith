/**
 * `createBot` is the documented entry point for AI opponents. Its existing
...
const botFor = (
  ...
  aiConfig?: unknown,
) => createBot(runner.game, RaceGame, 'race', seat, runner.actionHistory, difficulty, aiConfig as never);
...
describe('createBot', () => {
  ...
  it('accepts an AI config with objectives and still returns a move', async () => {
