...
program
  ...
  .option('--host <host>', 'Host to bind the server to (default: 127.0.0.1, local-only; pass 0.0.0.0 or --lan to serve to your whole network)')
  .option('--lan', 'Shorthand for --host 0.0.0.0 -- serves to your whole network')
