 ...
 * this is the ONLY place that addition should ever need to happen.
 *
 ...
 * and the retired blind-derivation module. Matches any of the three family names
 ...
 * (e.g. `VISUAL_LINE_RE`, `NAMED_BUT_UNDEFINED_LINE_RE` in `verify-derive-check.ts`, formerly
