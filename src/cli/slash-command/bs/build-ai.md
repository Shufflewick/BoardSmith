...
`/bs-build-ai` is normally invoked as a **late** sketch chunk in a `/bs-ingest-rules` +
...
as the AI-opponent chunk's pipeline (`${CLAUDE_SKILL_DIR}/../bs-shared/orchestrate/chunk-dispatch.md`).
